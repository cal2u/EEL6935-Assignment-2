...
### YOUR CODE HERE
REGULARIZATION = [0.1, 0.05, 0.01, 0.005, 0.001, 0.0005, 0.0001, 0.00005, 0.00001, 0.000005, 0.0000001, 0]
### END YOUR CODE
...
best_score = None
for result in results:
    if not best_score or result["dev"] > best_score:
        BEST_REGULARIZATION = result["reg"]
        BEST_WEIGHTS = result["weights"]
        best_score = result["dev"]
### END YOUR CODE
